 ...
 *
 * SimplePluginConfigurationTest.java is part of BukkitUtilities.
 *
...
public class ValidPluginConfigurationTest extends TestCase {
	...
	throws Exception {
		configuration.save();
		File file = FileUtils.resolveFile(folder.getRoot(), "valid.yml");
		String content = FileUtils.fileRead(file);
		assertTrue("Saved configuration has does not contain an element which should have been persisted!", content.contains("logging: INFO"));
	}
	...
	public void setUp()
	throws Exception {
		configuration = new SimplePluginConfiguration(folder.newFile("valid.yml"), getClass().getClassLoader().getResourceAsStream("config-valid.yml"));
	}
